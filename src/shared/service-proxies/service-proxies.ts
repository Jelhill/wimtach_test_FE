...
export class CollegeServiceProxy {
    ...
    getMyCustomList(): Observable<CollegeDto[]> {
        let url_ = this.baseUrl + "/api/services/app/College/GetMyCustomList";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    createMyCustomCollege(body: CreateCollegeDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/College/CreateMyCustomCollege";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateMyCustomCollege(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateMyCustomCollege(response_ as any);
                } catch (e) {
    ...
    protected processCreateMyCustomCollege(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    createMyCustomCollegeV2(body: CreateCollegeDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/College/CreateMyCustomCollegeV2";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    updateMyCustomCollege(body: UpdateCollegeDto | undefined): Observable<CollegeDto> {
        let url_ = this.baseUrl + "/api/services/app/College/UpdateMyCustomCollege";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateMyCustomCollege(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateMyCustomCollege(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CollegeDto>;
                }
            } else
    ...
    protected processUpdateMyCustomCollege(response: HttpResponseBase): Observable<CollegeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    deleteCollege(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/College/DeleteCollege?";
        if (id === null)
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteCollege(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCollege(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processDeleteCollege(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CollegeDto implements ICollegeDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.jeliliString = _data["jeliliString"];
    ...
    toJSON(data?: any) {
        ...
        data["jeliliString"] = this.jeliliString;
